...
fn suites() -> &'static [(&'static str, &'static [&'static str])] {
    &[
        ...
        (
            "phaseA05-crosswise",
            &["test", "-p", "git-command", "--test", "phaseA05_crosswise"],
        ),
        (
            "phaseA12-crosswise",
            &["test", "-p", "git-command", "--test", "phaseA12_crosswise"],
        ),
        (
            "phaseA10-crosswise",
            &["test", "-p", "git-command", "--test", "phaseA10_crosswise"],
        ),
        (
            "phaseA07-crosswise",
            &["test", "-p", "git-command", "--test", "phaseA07_crosswise"],
        ),
        (
            "phaseA06-crosswise",
            &["test", "-p", "git-command", "--test", "phaseA06_crosswise"],
        ),
        (
            "phaseA08-crosswise",
            &["test", "-p", "git-command", "--test", "phaseA08_crosswise"],
        ),
        (
            "phaseA09-crosswise",
        ...
        (
            "phaseA13-crosswise",
            &["test", "-p", "git-command", "--test", "phaseA13_crosswise"],
        ),
        (
            "phaseB01-crosswise",
            &["test", "-p", "git-command", "--test", "phaseB01_crosswise"],
        ),
        (
            "phaseB03-crosswise",
            &["test", "-p", "git-command", "--test", "phaseB03_crosswise"],
        ),
        (
            "phaseB04-crosswise",
            &["test", "-p", "git-command", "--test", "phaseB04_crosswise"],
        ),
        (
            "phaseB05-crosswise",
            &["test", "-p", "git-command", "--test", "phaseB05_crosswise"],
        ),
        (
            "phaseB06-crosswise",
            &["test", "-p", "git-command", "--test", "phaseB06_crosswise"],
        ),
        (
            "phaseB07-crosswise",
            &["test", "-p", "git-command", "--test", "phaseB07_crosswise"],
        ),
        (
            "phaseB08-crosswise",
            &["test", "-p", "git-command", "--test", "phaseB08_crosswise"],
        ),
    ]
}
